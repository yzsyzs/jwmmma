<template>
    <transition name="mei-message-fade">
        <div id="container_dailog" v-if="show" :class="['mei-message',type? `mei-message-${ type }` : '']"
        >
